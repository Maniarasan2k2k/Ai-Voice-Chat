...
import bg from "../assets/rob11.jpg"
...
try {
 ...
 <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062]  shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
